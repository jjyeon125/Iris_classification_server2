...
from flask import Flask, current_app, jsonfy, requst, abort, g, Response
...
class Ussers:
    ...
    def save(self) -> None:
        ...
        with self.app.config["USER_FILE"].open("w", newline ="") as user_file:
            ...
            writer.writeheader()
            writer.writerow(u.asdict() for u in self.users.values())

    def __len__(self) -> int:
        return len(self.users)
    
    def values(self) -> Iterable[User]:
